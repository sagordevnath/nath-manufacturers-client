...
const UpcomingProduct = () => {
  ...
  <figure className="px-10 pt-10">
    <img src="https://i.ibb.co/nMtST2M/upcoming1-1.jpg" alt="Shoes" className="rounded-xl" />
  </figure>
  <div className="card-body items-center text-center">
    <h2 className="card-title">Droon</h2>    
        ...
        <div className="card bg-base-100">
  <figure className="px-10 pt-10">
    <img src="https://i.ibb.co/FhZPCxd/upcoming2.jpg" alt="Shoes" className="rounded-xl" />
  </figure>
  <div className="card-body items-center text-center">
